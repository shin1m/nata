...
nata.main(@ test("insert", null, @(vi, type, update)
	...
	type("h"
	assert(update() == "INSERT 1,2-2 100% <0?3> "
	assert(vi.buffer().text.slice(0, -1) == "h"
	type("e"
	assert(update() == "INSERT 1,3-3 100% <0?3> "
...
nata.main(@ test("I inserts text before the first no-blank in the line", " 0", @(vi, type, update)
	...
	assert(vi.buffer().text.slice(0, -1) == " a0"
	type("b"
	assert(update() == "INSERT 1,3-3 100% <1?3>* "
...
nata.main(@ test("a appends text after the cursor", "01", @(vi, type, update)
	...
	assert(vi.buffer().text.slice(0, -1) == "0a1"
	type("b"
	assert(update() == "INSERT 1,5-5 100% <1?3>* "
...
nata.main(@ test("A appends text at the end of the line", "01", @(vi, type, update)
	...
	assert(vi.buffer().text.slice(0, -1) == "01"
	type("a^M"
	assert(update() == "INSERT 2,1-1 0% <0?3> "
	...
	assert(vi.buffer().text.slice(0, -1) == "01a\n"
	type("b"
	assert(update() == "INSERT 1,5-5 0% <1?3>* "
...
nata.main(@ test("o begins a new line below the cursor", "0\n1", @(vi, type, update)
	...
	assert(vi.buffer().text.slice(0, -1) == "0\n\n1"
	type("a"
	assert(update() == "INSERT 2,2-2 0% <0?3> "
	assert(vi.buffer().text.slice(0, -1) == "0\na\n1"
	type("^["
	assert(update() == "NORMAL 2,2-2 0% <1>* "
	assert(vi.buffer().text.slice(0, -1) == "0\na\n1"
	type("3o"
	assert(update() == "INSERT 3,1-1 0% <1?3>* "
	assert(vi.buffer().text.slice(0, -1) == "0\na\n\n1"
	type("bc"
	assert(update() == "INSERT 3,3-3 0% <1?3>* "
	assert(vi.buffer().text.slice(0, -1) == "0\na\nbc\n1"
	type("^["
	assert(update() == "NORMAL 5,3-3 0% <2>* "
	assert(vi.buffer().text.slice(0, -1) == "0\na\nbc\nbc\nbc\n1"
	type("."
	assert(update() == "NORMAL 8,3-3 0% <3>* "
	assert(vi.buffer().text.slice(0, -1) == "0\na\nbc\nbc\nbc\nbc\nbc\nbc\n1"
	type("1."
	assert(update() == "NORMAL 9,3-3 0% <4>* "
	assert(vi.buffer().text.slice(0, -1) == "0\na\nbc\nbc\nbc\nbc\nbc\nbc\nbc\n1"
	type("jo"
...
nata.main(@ test("O begins a new line above the cursor", "0\n1", @(vi, type, update)
	...
	assert(vi.buffer().text.slice(0, -1) == "\n0\n1"
	type("a"
	assert(update() == "INSERT 1,2-2 0% <0?3> "
	assert(vi.buffer().text.slice(0, -1) == "a\n0\n1"
	type("^["
	...
	assert(vi.buffer().text.slice(0, -1) == "a\n0\nbc\nbc\nbc\n1"
	type("."
	assert(update() == "NORMAL 7,3-3 0% <3>* "
	assert(vi.buffer().text.slice(0, -1) == "a\n0\nbc\nbc\nbc\nbc\nbc\nbc\n1"
	type("1."
	assert(update() == "NORMAL 7,3-3 0% <4>* "
	assert(vi.buffer().text.slice(0, -1) == "a\n0\nbc\nbc\nbc\nbc\nbc\nbc\nbc\n1"
