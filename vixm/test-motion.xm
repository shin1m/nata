...
nata.main(@ test("k/j moves upward/downward", "abc\nabc\na\nabcd", @(vi, type, update)
	...
	assert(update() == "NORMAL 1,4-4 100% <0> "
	type("jjj"
	assert(update() == "NORMAL 4,4-4 100% <0> "
	type("kkk"
	assert(update() == "NORMAL 1,4-4 100% <0> "
	type("2j"
	assert(update() == "NORMAL 3,2-2 100% <0> "
	type("2k"
	assert(update() == "NORMAL 1,4-4 100% <0> "
	type("4j"
	assert(update() == "NORMAL 4,4-4 100% <0> "
...
nata.main(@ test("-/+ moves upward/downward on the first non-blank", "\tabc\n  abc\n   \n abc", @(vi, type, update)
	type("+"
	assert(update() == "NORMAL 2,3-3 100% <0> "
	type("2+"
	assert(update() == "NORMAL 4,2-2 100% <0> "
	type("-"
	assert(update() == "NORMAL 3,4-4 100% <0> "
	type("2-"
	assert(update() == "NORMAL 1,2-2 100% <0> "
	type("4+"
	assert(update() == "NORMAL 4,2-2 100% <0> "
	type("l"
	assert(update() == "NORMAL 4,3-3 100% <0> "
	type("+"
	assert(update() == "NORMAL 4,3-3 100% <0> "
	type("4-"
	assert(update() == "NORMAL 1,2-2 100% <0> "
...
nata.main(@ test("w moves count words forward", "abc() abc\t()\n\nabc", @(vi, type, update)
	...
	assert(update() == "NORMAL 1,7-7 100% <0> "
	type("w"
	assert(update() == "NORMAL 1,11-11 100% <0> "
	type("w"
	assert(update() == "NORMAL 2,1-1 100% <0> "
	type("w"
	assert(update() == "NORMAL 3,1-1 100% <0> "
	type("w"
	assert(update() == "NORMAL 3,4-4 100% <0> "
