...
std::vector<std::pair<t_root, t_rvalue>> t_library::f_define()
{
	...
	return t_define(this)
		(L"Token"sv, t_object::f_of(v_type_token))
		(L"View"sv, t_object::f_of(v_type_view))
		(L"Overlay"sv, t_object::f_of(v_type_overlay))
		(L"OverlayIterator"sv, t_object::f_of(v_type_overlay_iterator))
		(L"Painter"sv, t_object::f_of(v_type_painter))
		(L"Creaser"sv, t_object::f_of(v_type_creaser))
