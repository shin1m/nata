...
$new = @(host, status, strip, path)
	...
	# TODO: do noremap
	map(builtin_maps.NORMAL, "C", "c$"
	map(builtin_maps.NORMAL, "D", "d$"
	map(builtin_maps.NORMAL, "S", "cc"
	map(builtin_maps.NORMAL, "X", "dh"
	map(builtin_maps.NORMAL, "s", "cl"
	map(builtin_maps.NORMAL, "x", "dl"
